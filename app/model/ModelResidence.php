    ...
    public function setPersonne_id($personne_id): void {
     ...
     public static function getAll() {
        try {
         ...
         $query = "SELECT p.prenom,p.nom,r.label,r.ville  FROM `personne` as p, `residence` as r WHERE p.id=r.personne_id AND p.id= :id";
     ...
     public static function getBilanAll() {///kjzhhqkhfkqzhkhdkqhdkuqd
        try {
         $database = Model::getInstance();
